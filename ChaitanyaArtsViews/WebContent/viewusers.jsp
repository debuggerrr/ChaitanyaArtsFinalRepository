		...
		<div class="content-wrapper">
			...
			<div class="row">
				...
				<s:if test="%{adduserList.size>0}">
					<table class="responstable2">
						...
						<s:iterator value="adduserList" status="stat">
							<tr>
								...
								<td><a href="getdata?selectuser.userName=<s:property value="userName"/>" class="btn btn-primary" >View / Edit</a></td>
									<td><a href="delete?deluser.userName=<s:property value="userName"/>" class="btn btn-warning">Delete</a></td>
					...
					<s:else>
					<s:form action="viewUsersAdminPanel">
								<input type="submit" class="btn btn-warning"
									value="View Users" style="margin: 15px 0px 0px 0px;" />
      ...
      <div class="modal-body">
       ...
       <div class="crevtbl"> 
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell2"><input name="updateuser.fullName" class="formtextfield" value="%{fullName}" type="text"><s:fielderror fieldName="adduser.fullName"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Address</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="updateuser.userAddress" class="formtextfield" type="text"><s:fielderror fieldName="adduser.userAddress"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Contact</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="updateuser.userContact" class="formtextfield" type="text" ><s:fielderror fieldName="adduser.userContact"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Email</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="updateuser.userEmail" class="formtextfield" type="text" ><s:fielderror fieldName="adduser.userEmail"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Date of Birth (YYYY-MM-DD)</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.userBirthDate" class="formtextfield" type="text"><s:fielderror fieldName="adduser.userBirthDate"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Username</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.userName" class="formtextfield" type="text"><s:fielderror fieldName="adduser.userName"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Password</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.passWord" class="formtextfield" type="text"><s:fielderror fieldName="adduser.passWord"/></div> 
						</div>
						
						<div class="crevtblRow"> 
							<div class="crevtblCell">Role</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><select name="adduser.userRole" class="adduserlistbox1">
				  <option>Admin</option>
				  <option>User</option>
				</select></div> 
		...
		<s:form action="updateUsersByAdmin">
					<div class="crevtblRow"> 
							...
							<div class="crevtblCell1"></div> 
							<div class="crevtblCell2"><button type="submit" class="btn btn-primary">Update User</button></div> 
						</div>

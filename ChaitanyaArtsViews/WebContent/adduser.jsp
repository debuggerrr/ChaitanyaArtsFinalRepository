				...
				<div>
					<div class="crevtbl"> 
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell2"><input name="adduser.fullName" class="formtextfield" type="text"><s:fielderror fieldName="adduser.fullName"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Address</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.userAddress" class="formtextfield" type="text"><s:fielderror fieldName="adduser.userAddress"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Contact</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.userContact" class="formtextfield" type="text" ><s:fielderror fieldName="adduser.userContact"/></div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Email</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><input name="adduser.userEmail" class="formtextfield" type="text" ><s:fielderror fieldName="adduser.userEmail"/></div> 
						</div>
						<div class="crevtblRow"> 
				  ...
				  <option>User</option>
						...
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell1"></div> 
							<div class="crevtblCell2"><button type="submit" class="btn btn-primary">Add User</button></div> 
						</div>
					</div>
				</div>
			</div>

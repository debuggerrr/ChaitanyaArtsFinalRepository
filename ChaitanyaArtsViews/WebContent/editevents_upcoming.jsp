...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="topbtnbar">
          	<a href="editevents.html" role="button" class="btn btn-success">Past Events</a>
			<a href="editevents_upcoming.jsp" role="button" class="btn btn-success">Upcoming Events</a>
			<a href="closedevents.html" role="button" class="btn btn-success">Closed Events</a>
			<br />
			<div class="crevtblCell2">Search : <input name="searchbar" class="formsearchfield" type="text" id="searchbar"></div>
			<div class="clear"></div>
          </div>
		  <div class="clear"></div>
  ...
  <tr>
    ...
    <td>Zee Network</td>
    <td>31/03/2016</td>
	<td><a href="viewevents.jsp" role="button" class="btn btn-primary">View / Edit</a></td>

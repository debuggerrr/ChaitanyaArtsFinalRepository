 ...
 <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
		  ...
		  <div class="row">
		  	<div class="debitote_form">
				...
				<div class="clear"></div>
				<div><input name="formtext3" class="debitote_formtextbox1" type="text" id="formtext3"></div>
				<div class="clear"></div>
				<div class="debitnotetext3">Debit Note No. :</div>
				<div><input name="formtext1" class="debitote_formtextbox2" type="text" id="formtext1"></div>
				<div class="clear"></div>
				<div class="debitnotetext3">Dated :</div>
				<div><input name="formtext1" class="debitote_formtextbox2" type="text" id="formtext1"><img src="dist/img/calender_icon.png" alt="calender_icon" class="calender_icon2" /></div>
				<div class="clear"></div>
  ...
  <tr>
    ...
    <td></td>
				...
				<div class="debitnotebtn"><button type="submit" class="btn btn-primary">Generate Debit Note</button></div>

		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="expenses.jsp">Expenses</a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<div class="container-fluid">
				<div class="row">
					...
					<s:form action="expensesAction">
						...
						<div>
							<div class="invoicetext1">Date :</div>
							<div>
								<input name="expenses.expenseDate" type="text"
									placeholder="YYYY-MM-DD">
								<s:fielderror fieldName="event.eventVenue" />
								</span>
							</div>

							<div class="invoicetext1">Particular :</div>
							<div>
								<input name="expenses.expenseParticular" type="text">
								<s:fielderror fieldName="expenses.expenseParticular" />
							</div>

							<div class="invoicetext1">Amount :</div>
							<div>
								<input name="expenses.expenseAmount" type="text">
								<s:fielderror fieldName="expenses.expenseAmount" />
							</div>

							<div>
								<input type="submit" class="btn btn-warning"
									value="Add Expenses" style="margin: 15px 0px 0px 0px;" />
							</div>
						</div>

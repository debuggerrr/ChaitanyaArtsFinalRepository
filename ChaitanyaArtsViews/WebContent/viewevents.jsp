...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 ...
 <body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="navbar navbar-static-top">
   ...
   <div class="viewtbl">
						<div class="viewtblRow">
							...
							<div class="viewtblCell2">Zee Cine Awards</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">Company Name</div> 
							<div class="viewtblCell5">:</div>
							<div class="viewtblCell6">Zee Network</div>
						</div>
						<div class="viewtblRow"> 
							<div class="viewtblCell">Contact Person Name</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">Mr. Prasad Kuvalekar</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">Contact</div> 
							<div class="viewtblCell5">:</div>
							<div class="viewtblCell6">+91 9826172540</div> 
						</div>
						<div class="viewtblRow"> 
							<div class="viewtblCell">Email</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">xyz@gmail.com</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">Event Vanue</div> 
							<div class="viewtblCell5">:</div>
							<div class="viewtblCell6">BKC Ground, Mumbai</div> 
					...
					<div class="viewtbl">
						<div class="viewtblRow"> 
							...
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">From : 15/04/2016 &nbsp; &nbsp; To : 18/04/2016</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">Event Time</div> 
							<div class="viewtblCell5">:</div> 
							<div class="viewtblCell6">7 PM</div> 
						</div>
						
						<div class="viewtblRow"> 
							<div class="viewtblCell">License Required</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2"><input name="licenserequired" type="checkbox" class="formcheckbox" value=""> More Licences</div>
							<div class="viewtblCell3">&nbsp;</div> 
  ...
  <tr>
    ...
    <td>Rs. 2,500</td>
    <td>Mr. Mahesh</td>
    <td>07/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
	<td>11/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
    <td><input name="licenserequired" type="checkbox" class="formcheckbox" value=""></td>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>Mr. Keshav</td>
    <td>07/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
	<td>10/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
    <td><input name="licenserequired" type="checkbox" class="formcheckbox" value="" checked></td>
    <td>124587</td>
	<td>10/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
    <td>Rs. 50,000</td>
	<td>HDFC Bank</td>
  ...
  <tr>
    ...
    <td>Mr. Prasad</td>
    <td>07/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
	<td>21/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
    <td><input name="licenserequired" type="checkbox" class="formcheckbox" value=""></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>Mr. Siddhesh</td>
    <td>07/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
	<td>25/03/2016 <span class="calender_icon1"><img src="dist/img/calender_icon.png" alt="calender_icon" border="none" /></span></td>
    <td><input name="licenserequired" type="checkbox" class="formcheckbox" value=""></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
  ...
  <div class="viewtbl">
						<div class="viewtblRow">
							...
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">Rs. 2,00,000</div>
							<div class="viewtblCell3">&nbsp;</div> 
						...
						<div class="viewtblRow"> 
							<div class="viewtblCell">Balance Amount</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">Rs. 1,00,000</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">Other Expenses</div> 
							<div class="viewtblCell5">:</div>
							<div class="viewtblCell6">Rs. 4,000</div> 
						</div>
					...
					<div class="notesbar">
						...
						<div class="notesbar_text2"><input name="notes" class="formtextfield_notes" type="text" id="notes"></div>
						<div class="clear"></div>
...
<a href="javascript: void(0)" 
   onclick="popup('popup.html')" class="btn btn-primary">Generate Bill</a>

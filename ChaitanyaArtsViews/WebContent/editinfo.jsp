    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
			...
			<li class="divider"></li>
            <li><a href="editevents.html">View/Edit Event</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="editinfo.html">Edit Info</a></li>
			<li class="divider"></li>
				...
				<div>
					<div class="crevtbl"> 
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell2"><s:textfield name="ownupdate.fullName" value="%{fullName}"
												size="40" /><s:fielderror fieldName="ownupdate.fullName"/>
					</div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Address</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2"><s:textfield name="ownupdate.userAddress"
												value="%{userAddress}" size="40" /><s:fielderror fieldName="ownupdate.userAddress"/>
									</div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Contact</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2">			<s:textfield name="ownupdate.userContact"
												value="%{userContact}" size="40" /><s:fielderror fieldName="ownupdate.userContact"/>
							</div>
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Email</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2">				<s:textfield name="ownupdate.userEmail" value="%{userEmail}"
												size="40" /><s:fielderror fieldName="ownupdate.userEmail"/>
							</div> 
						</div>
						<div class="crevtblRow"> 
							<div class="crevtblCell">Date of Birth (DD/MM/YYYY)</div> 
							<div class="crevtblCell1">:</div> 
							<div class="crevtblCell2">				<s:textfield name="ownupdate.userBirthDate"
												value="%{userBirthDate}" size="40" /><s:fielderror fieldName="ownupdate.userBirthDate"/>
						</div> 
						</div>
					<!--  	<div class="crevtblRow"> 
						...
						<div class="crevtblRow"> 
							...
							<div class="crevtblCell1"></div> 
							<div class="crevtblCell2"><input type="submit" class="btn btn-primary" value="Update"/> &nbsp; &nbsp;<input type="submit" class="btn btn-primary" value="Cancel"/></div> 

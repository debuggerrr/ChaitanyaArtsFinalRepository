...
<body class="hold-transition skin-blue sidebar-mini">
		  ...
		  <div class="billstopbar">
			...
			<div>
		  	...
		  	<div>
				...
				<div><select name="" class="reportslistbox1">
				...
				<div><input name="formtext1" class="reports_formtextbox1" type="text" id="formtext1"><img src="dist/img/calender_icon.png" alt="calender_icon" class="calender_icon2" /></div>
  ...
  <div class="viewtbl">
						<div class="viewtblRow">
							<div class="viewtblCell">Daily Expenses</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">Rs. 000</div>
						...
						<div class="viewtblRow"> 
							<div class="viewtblCell">Total Profit Earned</div> 
							<div class="viewtblCell1">:</div> 
							<div class="viewtblCell2">Rs. 000</div>
							<div class="viewtblCell3">&nbsp;</div> 
							<div class="viewtblCell4">&nbsp;</div> 
